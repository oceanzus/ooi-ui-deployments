...
sed -r -i -e "s|GOOGLE_ANALYTICS_URL: 'https://www.google-analytics.com/collect?v=1&tid=UA-50606390-3&cid=1&t=event'|GOOGLE_ANALYTICS_URL: '$GOOGLE_ANALYTICS_URL'|g" ooiservices/app/config.yml
